		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${partnershipInstanceList}" status="i" var="partnershipInstance">
					<li>
						<g:link action="show" id="${partnershipInstance.id}">${partnershipInstance}</g:link>
						<g:link action="edit" id="${partnershipInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
