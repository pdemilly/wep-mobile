		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${addressInstanceList}" status="i" var="addressInstance">
					<li>
						<g:link action="show" id="${addressInstance.id}">${addressInstance}</g:link>
						<g:link action="edit" id="${addressInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
